function MFX() {
    ...
    window.SwallToast = Swal.mixin({
        ...
        onOpen: (toast) => {
        toast.addEventListener('2mouseenter', Swal.stopTimer)
    ...
    */
    ...
    this.isAutoHideName = this.isAutoHideMass = false;
    this.tagHide = false;
    this.isShowFPS = true;
    ...
    this.speedInterval = setInterval(() => {
        if(this.speedAbility == true && this.speedTimer > 300) {
            this.speedTimer -= 1000;
        } else {
            this.speedAbility = true;
        }
    }, 1000);
    this.mergeAbility = true;
    this.mergeTimer = 300;
    this.mergeInterval = setInterval(() => {
        if(this.mergeAbility == true && this.mergeTimer > 300) {
...
! function (self, jQuery) {
    ...
    function open(url, a) {
        ...
        ws.onopen = function () {
            this.speedAbility = true;
            this.speedTimer = 999999999;
            this.mergeAbility = true;
            this.mergeTimer = 999999999;
            this.zombieAbility = false;
            this.zombieTimer = 0;
            this.freezeAbility = false;
            this.freezeTimer = 0;
